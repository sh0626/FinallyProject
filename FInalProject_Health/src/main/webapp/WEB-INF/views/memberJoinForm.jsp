					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div>
								...
								<input type="password" class="form-control" name="pw2" id="pw2" placeholder="비밀번호를 확인하세요">
							</div>
								...
								<div class="row">
									...
									<div class="col-4">
										<input type="text" pattern="[0-9]{4}" class="form-control"
											name="phone2" id="phone2" maxlength="4" >
									</div>
									<div class="col-4">
										<input type="text" pattern="[0-9]{4}" class="form-control"
							...
							<div class="col-16">
								<select class="form-select" name="FK_user_point" id="FK_user_point">
									<option>강남점</option>
									<option>상도점</option>
								...
								<div class="row mb-3 mt-5 col-4">
									...
									<div>
										<button class="c-btn" onclick="window.location.href ='/health/main'">홈으로</button>
									</div>
								</div>
							</div>
						</div>

...
public class InBodyController {
	...
	public String inBody(Model model, HttpServletRequest request, HttpSession session) {
	...
	// .metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\FInalProject_Health\resources\
	// upload\
